...
export default function EditReportDialog({ open, onClose, report, onUpdated }) {
  ...
  async function handleSave() {
    ...
    try {
      ...
      const updated = await apiPatch(`/api/reports/${report.id}/`, payload);
      onUpdated?.(updated);
      onClose();
    } catch (e) {
        ...
        <Stack spacing={2} sx={{ mt: 1 }}>
          ...
          <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
            <FormControl fullWidth>
              ...
              <FormHelperText>
                {report?.business_owner ? `Legacy: ${report.business_owner}` : "Select a user"}
              </FormHelperText>
            </FormControl>
            <FormControl fullWidth>
              ...
              <FormHelperText>
                {report?.technical_owner
                  ? `Legacy: ${report.technical_owner}`
                  : "Select a user"}
              </FormHelperText>
            </FormControl>
          </Stack>
          ...
          <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
            <FormControl fullWidth>
              ...
              <FormHelperText>
                {report?.developer ? `Legacy: ${report.developer}` : "Select a user"}
              </FormHelperText>
            </FormControl>
            <FormControl fullWidth>
